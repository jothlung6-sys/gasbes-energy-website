  ...
  const handleNewsletterSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch("https://formsubmit.co/ajax/info@gasbesenergy.com", {
        ...
        body: JSON.stringify({
          _subject: "New Gasbes Energy Newsletter Subscription",
          _template: "table",
          _honey: newsletterHoney,
          source: "Gasbes Energy website - Newsletter",
          email,
        }),
      });
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="md:col-span-2">
            ...
            <div className="mb-6">
              ...
              <p className="text-xs text-gray-400 mt-2">
                We only use your email for Gasbes Energy updates. You can unsubscribe at any time.
              </p>
            </div>
          </div>
        ...
        <div className="border-t border-gray-600 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="flex space-x-6 mb-4 md:mb-0">
            ...
            <a href="https://wa.me/260979491660" className="w-10 h-10 bg-gray-700 text-white rounded-full flex items-center justify-center hover:bg-warm-orange transition-colors">
          ...
          <div className="text-center md:text-right">
            <p className="text-gray-300 text-sm">
              © 2026 Gasbes Energy. All rights reserved.
            </p>
