    ...
    <section className="py-20 bg-gradient-to-br from-warm-orange to-earth-orange text-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4 text-coffee-brown">What Our Customers Say</h2>
          ...
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-white/20 backdrop-blur-sm p-8 rounded-2xl border border-white/20">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h4 className="font-bold text-lg text-coffee-brown">{testimonial.name}</h4>
                  <p className="text-coffee-brown/80 text-sm">{testimonial.title}</p>
                </div>
              </div>
              ...
              <p className="text-coffee-brown">{testimonial.content}</p>
            </div>
          ))}
        </div>
      </div>
